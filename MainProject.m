...
myFolder = 'C:\Users\Muskaan Patel\Desktop\Research Paper\Images\DATASET\benign';
...
for i = 1 : n
  ...
  %FeatureExtraction
  hello = regionprops('table',BoundaryExtracted,'MajorAxisLength','MinorAxisLength','ConvexArea','Solidity','Circularity'); %FEATU /............................;/......  . .RE 1
...
myFolder1 = 'C:\Users\Muskaan Patel\Desktop\Research Paper\Images\DATASET\try';
% Get a list of all files in the folder with the desired file name pattern.
...
% Specify the folder where normal samples are.
myFoldertest = 'C:\Users\Muskaan Patel\Desktop\Research Paper\Images\DATASET\testbenign';
% Get a list of all files in the folder with the desired file name pattern.
...
% Specify the folder where cancer samples are.
myFolder1test = 'C:\Users\Muskaan Patel\Desktop\Research Paper\Images\DATASET\testmalignant';
% Get a list of all files in the folder with the desired file name pattern.
...
t = features(:,5)';
x = train';
[trainedClassifier, validationAccuracy]= trainCoarseGaussianSVM(data,x,t);
